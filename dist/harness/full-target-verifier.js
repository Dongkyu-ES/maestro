...
import { appendRuntimeEvent, assertEvidenceBoundToLedgerHead, createRuntimeLedgerHeadBinding, readRuntimeEvents, } from '../events/ledger.js';
import { FULL_TARGET_REQUIREMENTS } from './full-target-gate.js';
        ...
        try {
            ...
            ledgerHeadBound =
                laterEvents.length === 1 &&
                    laterEvents.every((event) => event.source === 'harness' &&
